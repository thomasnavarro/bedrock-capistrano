...
DEVSITE="https://yoursite.local"

PRODDIR="deploy@yoursite.com:/srv/www/yoursite.prod/shared/uploads/"
PRODSITE="https://yoursite.prod"

STAGDIR="depoly@staging.yoursite.com:/srv/www/yoursite.com/shared/uploads/"
STAGSITE="https://staging.yoursite.com"
